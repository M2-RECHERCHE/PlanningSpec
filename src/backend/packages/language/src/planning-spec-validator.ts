...
export function registerValidationChecks(services: PlanningSpecServices) {
    ...
    const checks: ValidationChecks<PlanningSpecAstType> = {
        ...
        PreferResourceOnDate: validator.checkPreferResourceOnDate,
        PreferResourceSingleDay: validator.checkPreferResourceSingleDay
    };
...
export class PlanningSpecValidator {
    ...
    checkPreferResourceOnDate(
        preference: PreferResourceOnDate,
        accept: ValidationAcceptor
    ): void {
        if (preference.weight <= 0) {
            accept(
    ...
    checkPreferResourceSingleDay(
        preference: PreferResourceSingleDay,
        accept: ValidationAcceptor
    ): void {
        if (preference.weight <= 0) {
            accept(
