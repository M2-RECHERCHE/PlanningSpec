...
beforeAll(async () => {
    ...
    const doParse = parseHelper<Planification>(services.PlanningSpec);
...
function checkDocumentValid(document: LangiumDocument): string | undefined {
    ...
    `
        ...
        || !isPlanification(document.parseResult.value) && `Root AST object is a ${document.parseResult.value.$type}, expected a 'Planification'.`
        || undefined;
}
